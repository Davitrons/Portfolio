      ...
      >
        <div className="row align-items-center">
          ...
          <div className="col-md-8" data-aos="fade-left">
            ...
            <p className="lead">
              Desde que descubrí que una simple idea podía convertirse en una
              aplicación web funcional, supe que quería dedicarme a esto.
              Como desarrollador fullstack, me
              especializo en transformar conceptos en soluciones digitales
              reales, escalables y bien estructuradas.
            </p>

            <div className="d-flex justify-content-center gap-3 mt-4 flex-wrap">
              <a href="/cv.pdf" className="btn btn-warning">
                📄 Descargar CV
              </a>
              <a
